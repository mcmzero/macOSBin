...
#curl -s http://www.giniko.com/watch.php?id=26|grep playlist.m3u8|head -n1|sed -e 's/.*src="//' -e 's/">//' > /mnt/rasPiTorrent/torrent/방송/"CNN International.m3u"
...
#curl -s http://www.giniko.com/watch.php?id=189|grep playlist.m3u8|head -n1|sed -e 's/.*src="//' -e 's/">//' > /mnt/rasPiTorrent/torrent/방송/"BBC One.m3u"
